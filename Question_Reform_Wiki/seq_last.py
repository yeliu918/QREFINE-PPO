...
class BeamSearch_Seq2seq(object):
    ...
    def training(self):
        with tf.variable_scope(self.model_name + "Seq2Seq_decoder_model"):
    ...
    def RL_reward(self):
        ...
        # word_log_prob = self.predicting_scores
        # tf.placeholder(shape=[batch_size, max_target_length, beam_width], dtype=tf.float32, name='log_prob')
        ...
        self.rl_reward = - tf.reduce_mean(cross_entropy)
