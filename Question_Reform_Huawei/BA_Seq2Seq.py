...
def main():
    ...
    Dataset_name1 = "huawei"

    print "the huawei dataset"
    ...
    output = '/mnt/WDRed4T/ye/DataR/'+ Dataset_name + '/' + Dataset_name1 +"_vocab_embd"
    ...
    if model_type == 'training':
        ...
        with tf.Session(config=config) as sess:
            ...
            # saver.restore(sess,
            #               "/mnt/WDRed4T/ye/Qrefine/ckpt/CharS2S/" + Dataset_name + "/" + Dataset_name1 + "_" + str(
            #                   Bidirection) + "_Att_" + str(
            #                   Attention) + "_Emb_" + str(Embd_train) + "_hiddenunits_" + str(
            #                   num_units) + "_bleu_0.899180006287")
            ...
            for epo in range(epoch):
                    ...
                    if batch == 0 or batch % batches_in_epoch == 0:
                        ...
                        for batch_val in range(len(eval_noisy_Id) / batch_size):
                            ...
                            val_source_shuffle, val_source_len, val_train_shuffle, val_target_shuffle, val_target_len = next_batch(
                                eval_noisy_Id, eval_noisy_len, eval_input_Id, eval_target_Id, eval_clean_len, batch_size, batch_val, idx_v)
                ...
                if epo > 0:
                    ...
                    if patience_cnt > 5:
                        ...
                        saver.save(sess,
                                   "/mnt/WDRed4T/ye/Qrefine/ckpt/HUAWEI/" + Dataset_name +"/" + Dataset_name1 + str(Bidirection) + "_Att_" + str(
        ...
        with tf.Session(config=config) as sess:
            ...
            saver_word_rw.restore(sess, "/mnt/WDRed4T/ye/Qrefine/ckpt/S2S/" + Dataset_name + "/" + Dataset_name1  + str(Bidirection) + "_Att_" + str(
                                       Attention) + "_Emb_" + str(Embd_train) + "_hiddenunits_"+ str(num_units) + "_bleu_0.891196973815")
            ...
            # , len(test_answer_sen)
            fname = "/mnt/WDRed4T/ye/Qrefine/ckpt/S2S/" + Dataset_name + "/" + Dataset_name1 + str(bleu_score1)
            f = open(fname, "wb")
